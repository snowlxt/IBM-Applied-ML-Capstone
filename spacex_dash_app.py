...
def get_pie_chart(entered_site):    
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df['Launch Site']==entered_site].groupby('class').count().reset_index()[['class','Unnamed: 0']].rename(columns={'Unnamed: 0':'count'})
        fig = px.pie(filtered_df, 
            values='count', 
            names='class', 
...
def get_scatter_chart(entered_site, slider_range):
    ...
    if entered_site == 'ALL':
        #filtered_df = spacex_df[['Payload Mass (kg)','class','Launch Site']]
        ...
        fig = px.scatter(spacex_df[spacex_df['Launch Site']==entered_site][mask], x='Payload Mass (kg)', y='class',color="Booster Version Category",
